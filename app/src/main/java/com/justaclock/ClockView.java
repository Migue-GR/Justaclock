...
public class ClockView extends View {
    ...
    private MediaPlayer clockSong = MediaPlayer.create(getContext(), R.raw.clock_song);

    public ClockView(Context context) {
        super(context);
    }

    public ClockView(Context context, @androidx.annotation.Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClockView(Context context, @androidx.annotation.Nullable AttributeSet attrs, int defStyleAttr) {
